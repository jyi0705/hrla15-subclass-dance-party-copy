describe('psychedelicDancer', function() {
  ...
  var psychedelicDancer, clock;
  var timeBetweenSteps = 100;

  beforeEach(function() {
    clock = sinon.useFakeTimers();
    psychedelicDancer = new makePsychedelicDancer(10, 20, timeBetweenSteps);
  });
  ...
  it('should have a step function that makes its change color', function() {
    sinon.spy(psychedelicDancer.$node, 'animate');
    psychedelicDancer.step();
    expect(psychedelicDancer.$node.animate.called).to.be.true;
  });
